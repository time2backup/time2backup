...
tr_cannot_create_destination="Could not create backup destination directory."
...
tr_error_clean_backups="Cannot delete old backups. Please clean it manually."
...
tr_cannot_restore_from_trash="You cannot restore directories in trash mode!"
...
tr_email_report_failed="A backup failed on %s (exit code: %n)."
