...
tr_loading_config="Chargement de la configuration..."
tr_error_read_config="Le fichier de configuration est corrompu ou n'a pas pu être lu !"
...
tr_estimated_time="Temps estimé: %s minutes"
tr_backup_in_progress="Sauvegarde en cours..."
tr_backup_started_at="Démarré à : %s"
...
tr_warn_restore_partial="Vous allez restaurer un dossier à partir d'une sauvegarde incomplète! Il peut y avoir des fichiers manquants."
